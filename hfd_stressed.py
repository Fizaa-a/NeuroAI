...
def calculate_hfd_for_files(file_paths, k_max):
    ...
    for file_path in file_paths:
        ...
        if not file_path.endswith("_2.edf"):
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python hfd_stressed.py <file1.edf> <file2.edf> ...")
        sys.exit(1)
    ...
    csv_file_path = os.path.join(features_folder, 'stressed_hfd_values.csv')
